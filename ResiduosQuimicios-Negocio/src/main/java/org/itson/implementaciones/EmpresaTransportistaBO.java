 ...
 * @author TADEO
 *
 * Clase que representa la lógica de negocio (BO) para la gestión de empresas transportistas.
 * Implementa la interfaz iEmpresaTransportistaBO.
 */
 ...
 * 
 * @param empresaTransportistaRegistrar El objeto EmpresaTransportista que se registrará.
 ...
 * 
 * @param empresaTransportistaValidar El objeto EmpresaTransportista a validar.
 * @throws ValidacionesException Si la validación falla, indicando que el objeto EmpresaTransportista
 ...
 * 
 * @param empresaTransportistaValidar El ID de la EmpresaTransportista a validar.
